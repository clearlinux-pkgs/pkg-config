...
Version  : 2.2.0
Release  : 31
URL      : https://gitea.treehouse.systems/ariadne/pkgconf/archive/pkgconf-2.2.0.tar.gz
Source0  : https://gitea.treehouse.systems/ariadne/pkgconf/archive/pkgconf-2.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721849056
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpkgconf.so.5.0.0
/usr/lib64/libpkgconf.so.5
/usr/lib64/libpkgconf.so.5.0.0
